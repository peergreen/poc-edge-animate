...
"stage": {
   ...
   timelines: {
      "Default Timeline": {
         ...
         toState: "",
         duration: 44993.51794786,
         autoPlay: true,
         labels: {
            "start": 0
         },
         timeline: [
            { id: "eid2522", tween: [ "style", "${_speech-peergreen-earth}", "display", 'block', { fromValue: 'none'}], position: 34968, duration: 0 },
            { id: "eid2527", tween: [ "style", "${_speech-peergreen-earth}", "display", 'none', { fromValue: 'block'}], position: 38218, duration: 0 },
            { id: "eid1213", tween: [ "style", "${_prettycloud4}", "width", '80px', { fromValue: '80px'}], position: 0, duration: 0 },
            { id: "eid2553", tween: [ "style", "${_cloud}", "top", '-309px', { fromValue: '-59px'}], position: 40218, duration: 500 },
            { id: "eid2550", tween: [ "style", "${_speech-peergreen-cloud}", "left", '58px', { fromValue: '0px'}], position: 38218, duration: 500 },
            ...
            { id: "eid2610", tween: [ "style", "${_mine-bugs}", "left", '-110px', { fromValue: '21px'}], position: 24024, duration: 1000, easing: "swing" },
            ...
            { id: "eid2711", tween: [ "style", "${_road}", "display", 'none', { fromValue: 'block'}], position: 12750, duration: 0 },
            { id: "eid2210", tween: [ "style", "${_roadCopy}", "left", '-902px', { fromValue: '478px'}], position: 6000, duration: 6750 },
            { id: "eid1217", tween: [ "style", "${_prettycloud7}", "width", '80px', { fromValue: '80px'}], position: 0, duration: 0 },
            { id: "eid2733", tween: [ "style", "${_speech-peergreen}", "width", '297px', { fromValue: '297px'}], position: 12000, duration: 0 },
            ...
            { id: "eid2697", tween: [ "style", "${_truck-red}", "left", '920px', { fromValue: '240px'}], position: 11000, duration: 2000 },
            { id: "eid2710", tween: [ "style", "${_roadCopy}", "display", 'none', { fromValue: 'block'}], position: 12750, duration: 0 },
            { id: "eid2526", tween: [ "style", "${_speech-peergreen-earth}", "top", '121px', { fromValue: '125px'}], position: 34968, duration: 1250 },
            { id: "eid2736", tween: [ "style", "${_speech-peergreen}", "top", '79px', { fromValue: '-201px'}], position: 12000, duration: 750, easing: "easeOutBounce" },
            { id: "eid2379", tween: [ "style", "${_peergreen-logo}", "left", '352px', { fromValue: '952px'}], position: 40996, duration: 941 },
            { id: "eid511", tween: [ "style", "${_prettycloud6}", "left", '-570px', { fromValue: '2190px'}], position: 13218, duration: 23000 },
            { id: "eid2196", tween: [ "style", "${_prettycloud}", "bottom", '326px', { fromValue: '326px'}], position: 0, duration: 0 },
            { id: "eid2629", tween: [ "style", "${_cloud}", "background-size", [70,70], { valueTemplate: '@@0@@% @@1@@%', fromValue: [50,50]}], position: 28218, duration: 10000 },
            { id: "eid2699", tween: [ "style", "${_roadCopy4}", "display", 'none', { fromValue: 'block'}], position: 12750, duration: 0 },
            { id: "eid2700", tween: [ "style", "${_roadCopy4}", "display", 'none', { fromValue: 'none'}], position: 15000, duration: 0 },
            { id: "eid2686", tween: [ "style", "${_speech-oldmw}", "width", '253px', { fromValue: '253px'}], position: 6849, duration: 0 },
            { id: "eid2391", tween: [ "style", "${_sun}", "display", 'block', { fromValue: 'none'}], position: 12000, duration: 0, easing: "easeOutBounce" },
            { id: "eid2687", tween: [ "style", "${_speech-oldmw}", "top", '63px', { fromValue: '-197px'}], position: 4500, duration: 2349, easing: "easeOutBounce" },
            { id: "eid2549", tween: [ "style", "${_speech-peergreen-cloud}", "top", '20px', { fromValue: '-242px'}], position: 37968, duration: 750 },
            ...
            { id: "eid514", tween: [ "style", "${_prettycloud7}", "left", '-176px', { fromValue: '2584px'}], position: 13218, duration: 23000 },
            { id: "eid2306", tween: [ "style", "${_roadCopy2}", "display", 'none', { fromValue: 'block'}], position: 12750, duration: 0 },
            { id: "eid2233", tween: [ "style", "${_roadCopy2}", "display", 'none', { fromValue: 'none'}], position: 15000, duration: 0 },
            { id: "eid2525", tween: [ "style", "${_speech-peergreen-earth}", "left", '369px', { fromValue: '949px'}], position: 34968, duration: 1250 },
            { id: "eid2513", tween: [ "style", "${_server}", "top", '380px', { fromValue: '397px'}], position: 34968, duration: 1250 },
            { id: "eid2530", tween: [ "style", "${_server}", "top", '520px', { fromValue: '380px'}], position: 38218, duration: 500 },
            ...
            { id: "eid2735", tween: [ "style", "${_speech-peergreen}", "left", '18px', { fromValue: '18px'}], position: 12000, duration: 0 },
            ...
            { id: "eid2515", tween: [ "style", "${_raspberry}", "top", '401px', { fromValue: '418px'}], position: 34968, duration: 1250 },
            { id: "eid2531", tween: [ "style", "${_raspberry}", "top", '541px', { fromValue: '401px'}], position: 38218, duration: 500 },
            ...
            { id: "eid2613", tween: [ "style", "${_mine-dvlpt}", "left", '-124px', { fromValue: '23px'}], position: 23965, duration: 1000, easing: "swing" },
            { id: "eid2299", tween: [ "style", "${_balloon-jaxrs}", "top", '173px', { fromValue: '-208px'}], position: 28106, duration: 1000 },
            { id: "eid2518", tween: [ "style", "${_balloon-jaxrs}", "top", '153px', { fromValue: '173px'}], position: 34968, duration: 1250 },
            { id: "eid2545", tween: [ "style", "${_balloon-jaxrs}", "top", '-27px', { fromValue: '153px'}], position: 38218, duration: 500 },
            { id: "eid2566", tween: [ "style", "${_balloon-jaxrs}", "top", '123px', { fromValue: '-27px'}], position: 40218, duration: 500 },
            ...
            { id: "eid2597", tween: [ "style", "${_mine-infra}", "left", '-104px', { fromValue: '21px'}], position: 24024, duration: 1000, easing: "swing" },
            ...
            { id: "eid2209", tween: [ "style", "${_road}", "left", '-1380px', { fromValue: '0px'}], position: 6000, duration: 6750 },
            ...
            { id: "eid2512", tween: [ "style", "${_server}", "left", '195px', { fromValue: '1064px'}], position: 34968, duration: 1250 },
            { id: "eid512", tween: [ "style", "${_prettycloud3}", "left", '-1704px', { fromValue: '1056px'}], position: 13218, duration: 23000 },
            { id: "eid2662", tween: [ "style", "${_balloon-jpa-servlet}", "display", 'block', { fromValue: 'none'}], position: 10500, duration: 0 },
            { id: "eid1215", tween: [ "style", "${_prettycloud6}", "width", '80px', { fromValue: '80px'}], position: 0, duration: 0 },
            { id: "eid515", tween: [ "style", "${_prettycloud2}", "left", '-2026px', { fromValue: '734px'}], position: 13218, duration: 23000 },
            ...
            { id: "eid2380", tween: [ "style", "${_peergreen-logo}", "top", '370px', { fromValue: '410px'}], position: 40996, duration: 941 },
            ...
            { id: "eid2713", tween: [ "style", "${_balloon-jpa-servlet}", "top", '-220px', { fromValue: '-220px'}], position: 10500, duration: 0 },
            { id: "eid2723", tween: [ "style", "${_balloon-jpa-servlet}", "top", '1px', { fromValue: '-70px'}], position: 11116, duration: 884 },
            { id: "eid2725", tween: [ "style", "${_balloon-jpa-servlet}", "top", '90px', { fromValue: '1px'}], position: 12000, duration: 3000 },
            ...
            { id: "eid2516", tween: [ "style", "${_balloon-jpa-servlet}", "top", '150px', { fromValue: '170px'}], position: 34968, duration: 1250 },
            { id: "eid2541", tween: [ "style", "${_balloon-jpa-servlet}", "top", '-30px', { fromValue: '150px'}], position: 38218, duration: 500 },
            { id: "eid2562", tween: [ "style", "${_balloon-jpa-servlet}", "top", '120px', { fromValue: '-30px'}], position: 40218, duration: 500 },
            { id: "eid2371", tween: [ "style", "${_peergreen-logo}", "display", 'block', { fromValue: 'none'}], position: 40996, duration: 0 },
            { id: "eid2701", tween: [ "style", "${_roadCopy4}", "left", '530px', { fromValue: '1438px'}], position: 6000, duration: 6750 },
            ...
            { id: "eid2298", tween: [ "style", "${_balloon-jaxrs}", "display", 'block', { fromValue: 'none'}], position: 28106, duration: 0 },
            { id: "eid2730", tween: [ "style", "${_speech-peergreen}", "height", '188px', { fromValue: '188px'}], position: 12000, duration: 0 },
            { id: "eid2381", tween: [ "style", "${_peergreen-platform-overview}", "left", '306px', { fromValue: '906px'}], position: 40937, duration: 1000 },
            { id: "eid2533", tween: [ "style", "${_cloud}", "left", '346px', { fromValue: '766px'}], position: 37859, duration: 859 },
            { id: "eid2556", tween: [ "style", "${_cloud}", "left", '342px', { fromValue: '346px'}], position: 38718, duration: 1500 },
            { id: "eid513", tween: [ "style", "${_prettycloud4}", "left", '-1320px', { fromValue: '1440px'}], position: 13218, duration: 23000 },
            { id: "eid1208", tween: [ "style", "${_prettycloud3}", "height", '42px', { fromValue: '42px'}], position: 0, duration: 0 },
            { id: "eid2514", tween: [ "style", "${_raspberry}", "left", '87px', { fromValue: '956px'}], position: 34968, duration: 1250 },
            { id: "eid1714", tween: [ "style", "${_prettycloud8}", "display", 'none', { fromValue: 'block'}], position: 37968, duration: 0, easing: "easeInOutQuad" },
            { id: "eid2742", tween: [ "style", "${_speech-peergreen-upgrade}", "top", '134px', { fromValue: '-256px'}], position: 30049, duration: 1351, easing: "easeOutBounce" },
            ...
            { id: "eid2200", tween: [ "style", "${_speech-oldmw}", "display", 'block', { fromValue: 'block'}], position: 4500, duration: 0 },
            { id: "eid2409", tween: [ "style", "${_speech-oldmw}", "display", 'none', { fromValue: 'none'}], position: 8000, duration: 0, easing: "easeOutBounce" },
            ...
            { id: "eid2476", tween: [ "style", "${_mine-mngt}", "left", '22px', { fromValue: '271px'}], position: 18250, duration: 1309, easing: "swing" },
            { id: "eid2591", tween: [ "style", "${_mine-mngt}", "left", '-102px', { fromValue: '22px'}], position: 24024, duration: 941, easing: "swing" },
            ...
            { id: "eid2415", tween: [ "style", "${_speech-oldmw}", "left", '638px', { fromValue: '634px'}], position: 4500, duration: 2349, easing: "easeOutBounce" },
            { id: "eid2352", tween: [ "style", "${_speech-peergreen-upgrade}", "display", 'block', { fromValue: 'none'}], position: 30103, duration: 0 },
            { id: "eid2353", tween: [ "style", "${_speech-peergreen-upgrade}", "display", 'none', { fromValue: 'block'}], position: 34968, duration: 0 },
            { id: "eid2546", tween: [ "style", "${_speech-peergreen-cloud}", "display", 'block', { fromValue: 'none'}], position: 38218, duration: 0 },
            { id: "eid2551", tween: [ "style", "${_speech-peergreen-cloud}", "display", 'none', { fromValue: 'block'}], position: 40218, duration: 0 },
            ...
            { id: "eid2590", tween: [ "style", "${_mine-maintenance}", "left", '-120px', { fromValue: '19px'}], position: 24024, duration: 1000, easing: "swing" },
            ...
            { id: "eid2628", tween: [ "style", "${_cloud}", "display", 'block', { fromValue: 'none'}], position: 37859, duration: 0 },
            { id: "eid2737", tween: [ "style", "${_cloud}", "display", 'none', { fromValue: 'block'}], position: 42218, duration: 0, easing: "easeOutBounce" },
            { id: "eid2712", tween: [ "style", "${_balloon-jpa-servlet}", "left", '337px', { fromValue: '15px'}], position: 10500, duration: 616 },
            { id: "eid2728", tween: [ "style", "${_balloon-jpa-servlet}", "left", '307px', { fromValue: '337px'}], position: 11116, duration: 884 },
            { id: "eid2729", tween: [ "style", "${_balloon-jpa-servlet}", "left", '497px', { fromValue: '307px'}], position: 12000, duration: 3000 },
            ...
            { id: "eid2364", tween: [ "style", "${_balloon-jpa-servlet}", "left", '67px', { fromValue: '247px'}], position: 33968, duration: 1000 },
            { id: "eid2519", tween: [ "style", "${_balloon-jpa-servlet}", "left", '97px', { fromValue: '67px'}], position: 34968, duration: 1250 },
            { id: "eid2540", tween: [ "style", "${_balloon-jpa-servlet}", "left", '547px', { fromValue: '97px'}], position: 38218, duration: 500 },
            { id: "eid2557", tween: [ "style", "${_balloon-jpa-servlet}", "left", '543px', { fromValue: '547px'}], position: 38718, duration: 1500 },
            { id: "eid2561", tween: [ "style", "${_balloon-jpa-servlet}", "left", '53px', { fromValue: '543px'}], position: 40218, duration: 500 },
            ...
            { id: "eid2721", tween: [ "style", "${_app-green}", "top", '120px', { fromValue: '130px'}], position: 0, duration: 11116 },
            { id: "eid2722", tween: [ "style", "${_app-green}", "top", '196px', { fromValue: '120px'}], position: 11116, duration: 884 },
            { id: "eid2724", tween: [ "style", "${_app-green}", "top", '280px', { fromValue: '196px'}], position: 12000, duration: 3000 },
            ...
            { id: "eid2517", tween: [ "style", "${_app-green}", "top", '340px', { fromValue: '360px'}], position: 34968, duration: 1250 },
            { id: "eid2543", tween: [ "style", "${_app-green}", "top", '160px', { fromValue: '340px'}], position: 38218, duration: 500 },
            { id: "eid2564", tween: [ "style", "${_app-green}", "top", '310px', { fromValue: '160px'}], position: 40218, duration: 500 },
            { id: "eid2248", tween: [ "style", "${_app-green}", "display", 'block', { fromValue: 'block'}], position: 0, duration: 0 },
            { id: "eid510", tween: [ "style", "${_prettycloud8}", "left", '216px', { fromValue: '2976px'}], position: 13218, duration: 23000 },
            ...
            { id: "eid2382", tween: [ "style", "${_peergreen-platform-overview}", "top", '134px', { fromValue: '174px'}], position: 40937, duration: 1000 },
            { id: "eid2250", tween: [ "style", "${_app-green}", "left", '415px', { fromValue: '-395px'}], position: 1500, duration: 4500 },
            { id: "eid2726", tween: [ "style", "${_app-green}", "left", '385px', { fromValue: '415px'}], position: 11116, duration: 884 },
            { id: "eid2727", tween: [ "style", "${_app-green}", "left", '565px', { fromValue: '385px'}], position: 12000, duration: 3000 },
            ...
            { id: "eid2363", tween: [ "style", "${_app-green}", "left", '135px', { fromValue: '315px'}], position: 33968, duration: 1000 },
            { id: "eid2520", tween: [ "style", "${_app-green}", "left", '165px', { fromValue: '135px'}], position: 34968, duration: 1250 },
            { id: "eid2542", tween: [ "style", "${_app-green}", "left", '615px', { fromValue: '165px'}], position: 38218, duration: 500 },
            { id: "eid2555", tween: [ "style", "${_app-green}", "left", '611px', { fromValue: '615px'}], position: 38718, duration: 1500 },
            { id: "eid2563", tween: [ "style", "${_app-green}", "left", '121px', { fromValue: '611px'}], position: 40218, duration: 500 },
            { id: "eid2300", tween: [ "style", "${_balloon-jaxrs}", "left", '356px', { fromValue: '465px'}], position: 28106, duration: 1000 },
            { id: "eid2362", tween: [ "style", "${_balloon-jaxrs}", "left", '176px', { fromValue: '356px'}], position: 33968, duration: 1000 },
            { id: "eid2521", tween: [ "style", "${_balloon-jaxrs}", "left", '206px', { fromValue: '176px'}], position: 34968, duration: 1250 },
            { id: "eid2544", tween: [ "style", "${_balloon-jaxrs}", "left", '656px', { fromValue: '206px'}], position: 38218, duration: 500 },
            { id: "eid2554", tween: [ "style", "${_balloon-jaxrs}", "left", '652px', { fromValue: '656px'}], position: 38718, duration: 1500 },
            { id: "eid2565", tween: [ "style", "${_balloon-jaxrs}", "left", '162px', { fromValue: '652px'}], position: 40218, duration: 500 },
            { id: "eid2684", tween: [ "style", "${_speech-oldmw}", "height", '176px', { fromValue: '176px'}], position: 6849, duration: 0 },
            { id: "eid2305", tween: [ "style", "${_roadCopy3}", "display", 'none', { fromValue: 'block'}], position: 12750, duration: 0 },
            ...
            { id: "eid2208", tween: [ "style", "${_roadCopy3}", "left", '60px', { fromValue: '1438px'}], position: 6000, duration: 6750 },
            { id: "eid2484", tween: [ "style", "${_server}", "display", 'block', { fromValue: 'none'}], position: 34968, duration: 0 },
            { id: "eid997", tween: [ "style", "${_Stage}", "height", '500px', { fromValue: '500px'}], position: 0, duration: 0 },
            { id: "eid2354", tween: [ "style", "${_peergreen-platform-overview}", "display", 'block', { fromValue: 'none'}], position: 40937, duration: 0 },
            { id: "eid2698", tween: [ "style", "${_truck-red}", "display", 'none', { fromValue: 'block'}], position: 13000, duration: 0 },
            { id: "eid2646", tween: [ "style", "${_truck-red}", "display", 'none', { fromValue: 'none'}], position: 16500, duration: 0 },
            ...
            { id: "eid2207", tween: [ "style", "${_roadCopy2}", "left", '-422px', { fromValue: '958px'}], position: 6000, duration: 6750 },
            { id: "eid1209", tween: [ "style", "${_prettycloud3}", "width", '80px', { fromValue: '80px'}], position: 0, duration: 0 },
            { id: "eid517", tween: [ "style", "${_prettycloud}", "left", '-2576px', { fromValue: '184px'}], position: 13218, duration: 23000 },
            { id: "eid516", tween: [ "style", "${_prettycloud5}", "left", '-938px', { fromValue: '1822px'}], position: 13218, duration: 23000 },
            { id: "eid2482", tween: [ "style", "${_raspberry}", "display", 'block', { fromValue: 'none'}], position: 34968, duration: 0 },
