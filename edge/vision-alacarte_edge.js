   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid2444", tween: [ "style", "${_mine-dvlpt}", "left", '627px', { fromValue: '1156px'}], position: 14500, duration: 1500, easing: "swing" },
            { id: "eid2463", tween: [ "style", "${_mine-dvlpt}", "left", '23px', { fromValue: '627px'}], position: 16000, duration: 3500, easing: "swing" },
            ...
            { id: "eid2612", tween: [ "style", "${_mine-dvlpt}", "top", '277px', { fromValue: '277px'}], position: 19500, duration: 0 },
            ...
            { id: "eid2614", tween: [ "style", "${_truck-red}", "-moz-transform-origin", [63.55,82.05], { valueTemplate: '@@0@@% @@1@@%', fromValue: [63.55,82.05]}], position: 11000, duration: 0 },
            { id: "eid2615", tween: [ "style", "${_truck-red}", "-ms-transform-origin", [63.55,82.05], { valueTemplate: '@@0@@% @@1@@%', fromValue: [63.55,82.05]}], position: 11000, duration: 0 },
            { id: "eid2616", tween: [ "style", "${_truck-red}", "msTransformOrigin", [63.55,82.05], { valueTemplate: '@@0@@% @@1@@%', fromValue: [63.55,82.05]}], position: 11000, duration: 0 },
            { id: "eid2617", tween: [ "style", "${_truck-red}", "-o-transform-origin", [63.55,82.05], { valueTemplate: '@@0@@% @@1@@%', fromValue: [63.55,82.05]}], position: 11000, duration: 0 },
            ...
            { id: "eid2550", tween: [ "style", "${_speech-peergreen-cloud}", "left", '108px', { fromValue: '0px'}], position: 25000, duration: 500 },
            ...
            { id: "eid2549", tween: [ "style", "${_speech-peergreen-cloud}", "top", '80px', { fromValue: '-242px'}], position: 25000, duration: 500 }         ]
      }
   }
}
};
