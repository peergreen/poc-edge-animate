...
var Composition = Edge.Composition, Symbol = Edge.Symbol; // alias pour les classes Edge couramment utilisées
   ...
   (function(symbolName) {
       ...
       function reset (sym) {
         ...
         sym.$("ProfileDesc").html("</br>Profile not selected yet");
         sym.$("b_download").hide();
       }
      ...
      Symbol.bindElementAction(compId, symbolName, "${_b_pg-tomcat}", "mouseover", function(sym, e) {
         ...
         sym.$("ProfileDesc").html("Peergreen Tomcat</br>provides a Tomcat based web container.");
         	sym.$("p_tomcat").fadeIn();
      ...
      Symbol.bindElementAction(compId, symbolName, "${_b_pg-was}", "mouseover", function(sym, e) {
         var e = sym.$("b_pg-was");
         e.width(e.width()*1.2).height(e.height()*1.2);
         sym.$("ProfileDesc").html("Peergreen WAS</br>provides a Java EE web profile server.");
         	sym.$("p_tomcat").fadeIn();
         	sym.$("p_jotm").fadeIn();
      ...
      Symbol.bindElementAction(compId, symbolName, "${_b_pg-kernel}", "click", function(sym, e) {
         ...
         if (profile == "unknown") {
            ...
            sym.$("ProfileDesc").html("Peergreen Kernel</br>provides a lightweight OSGi server.");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_b_pg-osgi}", "mouseover", function(sym, e) {
         var e = sym.$("b_pg-osgi");
         e.width(e.width()*1.2).height(e.height()*1.2);
         sym.$("ProfileDesc").html("Peergreen Enterprise OSGi</br>provides an Enterprise OSGi server.");
         	sym.$("p_tomcat").fadeIn();
         	sym.$("p_jotm").fadeIn();
         	sym.$("p_hibernate").fadeIn();
         //	sym.$("p_easybeans").fadeIn();
      ...
      Symbol.bindElementAction(compId, symbolName, "${_b_cancel}", "click", function(sym, e) {
                  reset(sym);
