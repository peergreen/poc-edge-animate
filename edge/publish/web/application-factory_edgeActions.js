...
//Edge binding end
Symbol.bindTriggerAction(compId,symbolName,"Default Timeline",38034,function(sym,e){sym.$("button").fadeIn();sym.$("button2").fadeIn();sym.$("peergreen-platform").fadeIn();sym.$("t_button_restart").fadeIn();sym.$("t_button_url").fadeIn();sym.$("peergreen-logo").fadeIn();});
//Edge binding end
