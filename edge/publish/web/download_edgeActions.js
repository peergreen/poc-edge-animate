...
//Edge symbol: 'stage'
(function(symbolName){Symbol.bindTriggerAction(compId,symbolName,"Default Timeline",0,function(sym,e){sym.$("p_tomcat").hide();sym.$("p_easybeans").hide();sym.$("p_jotm").hide();sym.$("p_hibernate").hide();sym.$("p_jersey").hide();sym.$("p_joram").hide();sym.$("p_eclipselink").hide();sym.$("p_h2").hide();sym.$("p_derby").hide();sym.$("p_jetty").hide();sym.$("p_jdbc").hide();sym.$("p_jndi").hide();sym.$("p_aries").hide();sym.$("speech-alacarte").hide();sym.$("l_tomcat").show();sym.$("l_jotm").show();sym.$("l_hibernate").show();sym.$("l_easybeans").show();sym.$("l_jersey").show();sym.$("l_h2").show();sym.$("l_jdbc").show();sym.$("l_jndi").show();sym.$("l_aries").show();sym.$("b_pg-kernel").show();sym.$("b_pg-tomcat").show();sym.$("b_pg-was").show();sym.$("b_pg-osgi").show();sym.$("b_pg-embedded").show();sym.setVariable("profile","unknown");sym.$("ProfileDetail").html("</br>Profile not selected yet");sym.$("b_download").fadeOut();sym.stop();});
//Edge binding end
Symbol.bindElementAction(compId,symbolName,"${_b_download}","click",function(sym,e){var profile=sym.getVariable("profile");if(profile!="unknown"){alert("Profile = "+profile);}});
//Edge binding end
Symbol.bindElementAction(compId,symbolName,"${_b_reset}","click",function(sym,e){sym.play("reset");});
//Edge binding end
Symbol.bindElementAction(compId,symbolName,"${_l_jersey}","click",function(sym,e){var profile=sym.getVariable("profile");if(profile=="unknown"){sym.$("b_pg-kernel").fadeOut();sym.$("b_pg-embedded").fadeOut();sym.$("b_pg-tomcat").fadeOut();sym.$("b_pg-osgi").fadeOut();sym.$("l_aries").fadeOut();sym.$("p_jersey").fadeIn();}});
//Edge binding end
Symbol.bindElementAction(compId,symbolName,"${_l_tomcat}","mouseover",function(sym,e){sym.$("FeatureDetail").html("Tomcat</br>Web Container</br>[Servlet 3.0]</br>[HTTP Service]");var e=sym.$("l_tomcat");e.width(e.width()*1.1).height(e.height()*1.1);});
//Edge binding end
Symbol.bindElementAction(compId,symbolName,"${_l_tomcat}","click",function(sym,e){var profile=sym.getVariable("profile");if(profile=="unknown"){sym.$("b_pg-kernel").fadeOut();sym.$("b_pg-embedded").fadeOut();sym.$("p_tomcat").fadeIn();}});
//Edge binding end
Symbol.bindElementAction(compId,symbolName,"${_l_jotm}","mouseover",function(sym,e){sym.$("FeatureDetail").html("JOTM</br>Transaction</br>[JTA]");var e=sym.$("l_jotm");e.width(e.width()*1.1).height(e.height()*1.1);});
//Edge binding end
Symbol.bindElementAction(compId,symbolName,"${_l_hibernate}","mouseover",function(sym,e){sym.$("FeatureDetail").html("Hibernate</br>Persistence</br>[JPA]");var e=sym.$("l_hibernate");e.width(e.width()*1.1).height(e.height()*1.1);});
//Edge binding end
Symbol.bindElementAction(compId,symbolName,"${_l_jdbc}","mouseover",function(sym,e){sym.$("FeatureDetail").html("JDBC</br>JDBC Connection Pool");var e=sym.$("l_jdbc");e.width(e.width()*1.1).height(e.height()*1.1);});
//Edge binding end
Symbol.bindElementAction(compId,symbolName,"${_l_jersey}","mouseover",function(sym,e){sym.$("FeatureDetail").html("Jersey</br>Web Service</br>[JAX-RS 2.0]");var e=sym.$("l_jersey");e.width(e.width()*1.1).height(e.height()*1.1);});
//Edge binding end
Symbol.bindElementAction(compId,symbolName,"${_l_easybeans}","mouseover",function(sym,e){sym.$("FeatureDetail").html("Easybeans</br>EJB Container</br>[EJB 3.1]");var e=sym.$("l_easybeans");e.width(e.width()*1.1).height(e.height()*1.1);});
//Edge binding end
Symbol.bindElementAction(compId,symbolName,"${_l_h2}","mouseover",function(sym,e){sym.$("FeatureDetail").html("H2</br>Java Database</br>");var e=sym.$("l_h2");e.width(e.width()*1.1).height(e.height()*1.1);});
//Edge binding end
Symbol.bindElementAction(compId,symbolName,"${_l_easybeans}","click",function(sym,e){var profile=sym.getVariable("profile");if(profile=="unknown"){sym.$("b_pg-kernel").fadeOut();sym.$("b_pg-embedded").fadeOut();sym.$("b_pg-tomcat").fadeOut();sym.$("p_easybeans").fadeIn();}});
//Edge binding end
Symbol.bindElementAction(compId,symbolName,"${_l_hibernate}","click",function(sym,e){var profile=sym.getVariable("profile");if(profile=="unknown"){sym.$("b_pg-kernel").fadeOut();sym.$("b_pg-embedded").fadeOut();sym.$("b_pg-tomcat").fadeOut();sym.$("p_hibernate").fadeIn();}});
//Edge binding end
Symbol.bindElementAction(compId,symbolName,"${_l_jotm}","click",function(sym,e){var profile=sym.getVariable("profile");if(profile=="unknown"){sym.$("b_pg-kernel").fadeOut();sym.$("b_pg-embedded").fadeOut();sym.$("b_pg-tomcat").fadeOut();sym.$("p_jotm").fadeIn();}});
//Edge binding end
Symbol.bindElementAction(compId,symbolName,"${_l_h2}","click",function(sym,e){var profile=sym.getVariable("profile");if(profile=="unknown"){sym.$("b_pg-kernel").fadeOut();sym.$("b_pg-embedded").fadeOut();sym.$("b_pg-tomcat").fadeOut();sym.$("b_pg-osgi").fadeOut();sym.$("p_h2").fadeIn();}});
//Edge binding end
Symbol.bindElementAction(compId,symbolName,"${_l_jdbc}","click",function(sym,e){var profile=sym.getVariable("profile");if(profile=="unknown"){sym.$("b_pg-kernel").fadeOut();sym.$("b_pg-embedded").fadeOut();sym.$("b_pg-tomcat").fadeOut();sym.$("b_pg-osgi").fadeOut();sym.$("p_jdbc").fadeIn();}});
//Edge binding end
Symbol.bindElementAction(compId,symbolName,"${_l_tomcat}","mouseout",function(sym,e){sym.$("FeatureDetail").html("");var e=sym.$("l_tomcat");e.width(e.width()/1.1).height(e.height()/1.1);});
//Edge binding end
Symbol.bindElementAction(compId,symbolName,"${_l_jotm}","mouseout",function(sym,e){sym.$("FeatureDetail").html("");var e=sym.$("l_jotm");e.width(e.width()/1.1).height(e.height()/1.1);});
//Edge binding end
Symbol.bindElementAction(compId,symbolName,"${_l_hibernate}","mouseout",function(sym,e){sym.$("FeatureDetail").html("");var e=sym.$("l_hibernate");e.width(e.width()/1.1).height(e.height()/1.1);});
//Edge binding end
Symbol.bindElementAction(compId,symbolName,"${_l_jdbc}","mouseout",function(sym,e){sym.$("FeatureDetail").html("");var e=sym.$("l_jdbc");e.width(e.width()/1.1).height(e.height()/1.1);});
//Edge binding end
Symbol.bindElementAction(compId,symbolName,"${_l_jersey}","mouseout",function(sym,e){sym.$("FeatureDetail").html("");var e=sym.$("l_jersey");e.width(e.width()/1.1).height(e.height()/1.1);});
//Edge binding end
Symbol.bindElementAction(compId,symbolName,"${_l_easybeans}","mouseout",function(sym,e){sym.$("FeatureDetail").html("");var e=sym.$("l_easybeans");e.width(e.width()/1.1).height(e.height()/1.1);});
//Edge binding end
Symbol.bindElementAction(compId,symbolName,"${_l_h2}","mouseout",function(sym,e){sym.$("FeatureDetail").html("");var e=sym.$("l_h2");e.width(e.width()/1.1).height(e.height()/1.1);});
//Edge binding end
...
//Edge binding end
Symbol.bindElementAction(compId,symbolName,"${_l_jndi}","mouseout",function(sym,e){sym.$("FeatureDetail").html("");var e=sym.$("l_jndi");e.width(e.width()/1.1).height(e.height()/1.1);});
//Edge binding end
})("stage");
