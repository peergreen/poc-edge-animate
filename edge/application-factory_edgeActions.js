...
var Composition = Edge.Composition, Symbol = Edge.Symbol; // alias pour les classes Edge couramment utilisées
   ...
   (function(symbolName) {
      ...
      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 0, function(sym, e) {
         ...
         sym.$("p_tomcat2").hide();
         sym.$("p_jetty2").hide();
         sym.$("p_eclipselink2").hide();
         sym.$("p_hibernate2").hide();
         sym.$("p_easybeans2").hide();
         sym.$("p_h22").hide();
         sym.$("p_derby2").hide();
         sym.$("p_jotm2").hide();
         sym.$("p_joram2").hide();
         sym.$("p_jersey2").hide();
         sym.$("p_business2").hide();
         
         sym.$("speech_build").hide();
         sym.$("t_speech_build").hide();
         sym.$("speech_deploy").hide();
         sym.$("t_speech_deploy").hide();
         
         sym.$("button").hide();
         sym.$("button2").hide();
         sym.$("peergreen-platform").hide();
         sym.$("peergreen-logo").hide();
         
         //définir la valeur d’une variable de symbole
         sym.setVariable("busy", "false");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_raspberry2}", "click", function(sym, e) {
         ...
         if (isBusy == "false") {
         	sym.setVariable("busy", "true");
         	sym.setVariable("deployTarget", "raspberry");
         	sym.play("begin_deploy");
         }
      ...
      Symbol.bindElementAction(compId, symbolName, "${_b_eclipselink}", "click", function(sym, e) {
         ...
         if (isBusy == "false") {
         	sym.setVariable("busy", "true");
         	sym.$("p_eclipselink").show();
         	sym.$("p_hibernate").hide();
         	sym.$("kernel").show();
         	sym.play("begin_eclipselink");
         }
      ...
      Symbol.bindElementAction(compId, symbolName, "${_b_hibernate}", "click", function(sym, e) {
         ...
         if (isBusy == "false") {
         	sym.setVariable("busy", "true");
         	sym.$("p_eclipselink").hide();
         	sym.$("p_hibernate").show();
         	sym.$("kernel").show();
         	sym.play("begin_hibernate");
         }
      ...
      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 8444, function(sym, e) {
         sym.$("p_hibernate").hide();
         sym.$("p_hibernate2").show();
         sym.$("p_eclipselink2").hide();
         sym.stop();
         sym.setVariable("busy", "false");
      ...
      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 636, function(sym, e) {
         sym.stop();
      ...
      Symbol.bindElementAction(compId, symbolName, "${_b_easybeans}", "click", function(sym, e) {
         ...
         if (isBusy == "false") {
         	sym.setVariable("busy", "true");
         	sym.$("p_easybeans").show();
         	sym.$("kernel").show();
         	sym.play("begin_easybeans");
         }
      ...
      Symbol.bindElementAction(compId, symbolName, "${_b_joram}", "click", function(sym, e) {
         var isBusy = sym.getVariable("busy");
         if (isBusy == "false") {
         	sym.setVariable("busy", "true");
         	sym.$("p_joram").show();
         	sym.$("kernel").show();
         	sym.play("begin_joram");
         }
      ...
      Symbol.bindElementAction(compId, symbolName, "${_b_business}", "click", function(sym, e) {
         var isBusy = sym.getVariable("busy");
         if (isBusy == "false") {
         	sym.setVariable("busy", "true");
         	sym.$("p_business").show();
         	sym.$("kernel").show();
         	sym.play("begin_business");
         }
      ...
      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 40711, function(sym, e) {
         sym.$("t_speech_build").show()

      });
      //Edge binding end

      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 43737, function(sym, e) {
         sym.$("t_speech_deploy").show()

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_server}", "click", function(sym, e) {
         var isBusy = sym.getVariable("busy");
         if (isBusy == "false") {
         	sym.setVariable("busy", "true");
         	sym.setVariable("deployTarget", "server");
         	sym.play("begin_deploy");
         }
      ...
      Symbol.bindElementAction(compId, symbolName, "${_cloud}", "click", function(sym, e) {
         var isBusy = sym.getVariable("busy");
         if (isBusy == "false") {
         	sym.setVariable("busy", "true");
         	sym.setVariable("deployTarget", "cloud");
         	sym.play("begin_deploy");
         }
      ...
      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 33000, function(sym, e) {
         sym.$("kernel").hide();
         sym.stop();
         var deployTarget = sym.getVariable("deployTarget");
         if (deployTarget == "raspberry") {
         	sym.play("begin_raspberry");
         } else if (deployTarget == "server") {
         	sym.play("begin_server");
         } else if (deployTarget == "cloud") {
         	sym.play("begin_cloud");
         }
      ...
      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 29990, function(sym, e) {
         sym.setVariable("busy", "true");

      });
      //Edge binding end

      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 35958, function(sym, e) {
         sym.setVariable("busy", "false");
         sym.stop();
         sym.play("begin_end");
      ...
      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 37859, function(sym, e) {
         sym.setVariable("busy", "false");
         sym.stop();
         sym.play("begin_end");
      ...
      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 38034, function(sym, e) {
         sym.$("button").fadeIn();
         sym.$("button2").fadeIn();
         sym.$("peergreen-platform").fadeIn();
         sym.$("t_button_restart").fadeIn();
         sym.$("t_button_url").fadeIn();
         sym.$("peergreen-logo").fadeIn();
      ...
      Symbol.bindElementAction(compId, symbolName, "${_button2}", "click", function(sym, e) {
         ...
         sym.stop();
         window.open("http://www.peergreen.com/Download/WebHome", "_self");
